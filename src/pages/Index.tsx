    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <div className="fixed -z-10 top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        ...
        {[...Array(4)].map((_, i) => (
          <div
            key={`droplet-${i}`}
            className="absolute animate-[droplet_15s_linear_infinite] opacity-10"
            style={{
              left: `${Math.random() * 100}%`,
              top: `-50px`,
        ...
        {[...Array(2)].map((_, i) => (
          <div
            key={`tool-${i}`}
            className="absolute animate-[spin_20s_linear_infinite] opacity-5"
            style={{
              right: `${20 + i * 40}%`,
              bottom: `${20 + i * 30}%`,
        ...
        <div
          className="absolute animate-[spray_4s_ease-in-out_infinite] opacity-10"
          style={{
            right: '10%',
            top: '20%'
          }}
